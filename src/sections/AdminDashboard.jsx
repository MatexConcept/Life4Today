...
//     try {
//       const response = await fetch("http://localhost:2002/form/get-form-data", {
//         method: "POST",
//         headers: {
...
//     <div>
//       <div>
//         <button onClick={() => setActiveTab("credit-card")}>
//           Credit Card Donations
//         </button>
//         <button onClick={() => setActiveTab("bitcoin")}>
//           Bitcoin Donations
//         </button>
//         <button onClick={() => setActiveTab("paypal")}>
//           PayPal Donations
//         </button>
//       </div>
//       {renderTable()}
...
const AdminDashboard = () => {
  ...
  const handleEditBtcWallet = async () => {
    try {
      const response = await fetch("http://localhost:2002/form/edit-btc-wallet-address", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleEditPaypalDetails = async () => {
    try {
      const response = await fetch("http://localhost:2002/form/edit-paypal-details", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
